...
import de.hub.corpling.pepper.pepperInterface.impl.PepperManipulatorImpl;
 ...
 * Pepper Framework. Therefor you have to take a look to todos and adapt the code.
 * 
 * <ul>
 ...
 *
 */
public class PerseusManipulator extends PepperManipulatorImpl 
{
	public PerseusManipulator()
	{
		super();
		
		{//setting name of module
			//TODO /1/: change the name of the module, for example use the format name and the ending Manipulator (FORMATManipulator)
